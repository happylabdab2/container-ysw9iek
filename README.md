...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ysw9iek.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ysw9iek.containers.anotherwebservice.com/
...
```
git clone git@github.com:happylabdab2/container-ysw9iek.git
cd container-ysw9iek
```
...
```
docker attach container-ysw9iek
```
